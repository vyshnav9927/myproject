...
function wpmlm_install() {
    ...
    create_wpmlm_unpaid_users_table();
...
function wc_wp_mlm_install_woocommerce_admin_notice() {
    ?>
    <div class="error">
        <p><?php esc_html_e( 'WP MLM Woocommerce - Matrix Plan is enabled but not effective. It requires WooCommerce in order to work.', 'woocommerce-securewpmlm-unilevel' ); ?></p>
    </div>
    <?php
}
